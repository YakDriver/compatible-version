...
*compatibleversion* could always use more documentation, whether as part of the official
*compatibleversion* docs, in docstrings, or even on the web in blog posts, articles, and
...
To set up *compatibleversion* for local development:

1.  Fork [*compatibleversion*](https://github.com/plus3it/compatibleversion) (look for the
    "Fork" button).

2.  Clone your fork locally:

    ```shell
    git clone https://github.com/your_name_here/compatibleversion.git && cd compatibleversion
    ```
...
[0]: https://github.com/plus3it/compatibleversion/issues
[1]: https://travis-ci.org/plus3it/compatibleversion/pull_requests
